...
INSERT INTO `site_ayarlari` (`anahtar`, `deger`, `deger_turu`, `aciklama`) VALUES
    ...
    ('vana_vitrini_etiketi', 'DEMİRVANA ÜRÜNLERİ', 'metin', 'Ana sayfadaki kayan vana vitrininin üst etiketi'),
    ('vana_vitrini_basligi', 'Akışın Her Noktasına Güvenilir Çözümler', 'metin', 'Ana sayfadaki kayan vana vitrininin başlığı'),
    ('vana_vitrini_aciklamasi', 'Farklı tesis ihtiyaçları için geliştirdiğimiz vana gruplarını yakından inceleyin.', 'metin', 'Ana sayfadaki kayan vana vitrininin açıklaması'),
    ('vana_vitrini_alt_metni', 'Projeniz için doğru vana çözümünü birlikte belirleyelim.', 'metin', 'Kayan vana vitrininin alt çağrı metni'),
    ('vana_vitrini_buton_metni', 'Teknik destek alın', 'metin', 'Kayan vana vitrininin buton metni'),
    ('vana_vitrini_buton_baglantisi', '/iletisim', 'metin', 'Kayan vana vitrininin buton bağlantısı'),
