...
UPDATE `urunler` SET `teknik_bilgiler` = '{"katalog_bilgileri":{"gorsel_yolu":"/assets/urunler/genel/hvac-bimetal-thermometre-byk.jpg"},"urun_tanimi":{"baslik":"HVAC BİMETAL THERMOMETRE BYK","satirlar":[]},"teknik_cizim_yolu":"/assets/urunler/hvac-bimetal-thermometre-byk/teknik-cizim.jpg"}' WHERE `slug` = 'hvac-bimetal-thermometre-byk';
UPDATE `urunler` SET `teknik_bilgiler` = '{"katalog_bilgileri":{"gorsel_yolu":"/assets/urunler/genel/endustriyel-termometre.jpg"},"urun_tanimi":{"baslik":"ENDÜSTRİYEL TERMOMETRE","satirlar":[]},"teknik_cizim_yolu":"/assets/urunler/endustriyel-termometre/teknik-cizim.jpg"}' WHERE `slug` = 'endustriyel-termometre';
