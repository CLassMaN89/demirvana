...
export const ornekVeriler = Object.freeze({
  ...
  site_ayarlari: {
    ...
    vana_vitrini_etiketi: 'DEMİRVANA ÜRÜNLERİ',
    vana_vitrini_basligi: 'Akışın Her Noktasına Güvenilir Çözümler',
    vana_vitrini_aciklamasi: 'Farklı tesis ihtiyaçları için geliştirdiğimiz vana gruplarını yakından inceleyin.',
    vana_vitrini_alt_metni: 'Projeniz için doğru vana çözümünü birlikte belirleyelim.',
    vana_vitrini_buton_metni: 'Teknik destek alın',
    vana_vitrini_buton_baglantisi: '/iletisim',
