      ...
      <div className="iletisim-icerik icerik-kapsayici">
        ...
        <section className="iletisim-form-karti" aria-labelledby="mesaj-basligi">
          ...
          <form onSubmit={gonder}>
            {/* İkon her zaman görünür kalır; yalnızca yazı, alan odaklanınca veya doldurulunca kaybolup
                yerini yazılan metne bırakır (etiket girdiden sonra gelip CSS ile boşken/odaklanmamışken gösterilir). */}
            <label><input name="ad_soyad" aria-label="İsim Soyisim" autoComplete="name" maxLength="120" placeholder=" " required /><span><FontAwesomeIcon icon={faUser} /><em> İsim Soyisim</em></span></label>
            <label><input name="eposta" aria-label="E-posta" type="email" autoComplete="email" maxLength="180" placeholder=" " required /><span><FontAwesomeIcon icon={faEnvelope} /><em> E-posta</em></span></label>
            <label><input name="telefon" aria-label="Telefon" type="tel" autoComplete="tel" maxLength="40" placeholder=" " required /><span><FontAwesomeIcon icon={faPhone} /><em> Telefon</em></span></label>
            <label><input name="firma" aria-label="Firma" autoComplete="organization" maxLength="180" placeholder=" " /><span><FontAwesomeIcon icon={faBuilding} /><em> Firma</em></span></label>
            <label className="iletisim-form__mesaj"><textarea name="mesaj" aria-label="Mesajınız" rows="6" maxLength="3000" placeholder=" " required /><span><FontAwesomeIcon icon={faMessage} /><em> Mesajınız</em></span></label>
