...
- Ziyaretçi İstatistikleri ekranında "Son Ziyaretler" tablosunun gereksiz büyük boşluğu kaldırıldı. "IP Bazında Toplam Kalma Süresi" kayıtları tarih ve IP bazında günlük açılır yapıya geçirildi; bugün dışındaki günler `13 Eylül 2026` biçiminde gösterilir ve IP sayfa dökümü seçilen tarihle sınırlandırılır. Gün ve IP akordeonlarında aynı anda yalnızca bir bölüm açık kalır; böylece üstteki iki kart masaüstünde eşit ve sabit yükseklikte kalır. Önceki/sonraki düğmeleri eşit ölçüdedir ve son sayfadaki kayıt sayısı azalsa da sayfalama konumu değişmez. İç kaydırma kullanılmaz.
