...
- `Sıralama Değişimi` grafiği verilen `Social Media Activity` referansına uygun dolgusu olmayan Recharts `LineChart` yapısına geçirildi. Kesik yatay grid, yüzde ekseni, site rengini taşıyan tarih/saat tooltip'i, beyaz merkezli aktif ölçüm noktaları ve halka biçimli site lejantları kullanılır. Grafik testi, Masaüstü/Mobil etiketlerinin bulunmadığını ayrıca doğrular.
