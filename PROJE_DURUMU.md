...
- Ziyaretçi İstatistikleri ekranında "Son Ziyaretler" tablosunun gereksiz büyük boşluğu kaldırıldı. "IP Bazında Toplam Kalma Süresi" kayıtları tarih ve IP bazında günlük açılır yapıya geçirildi; bugün dışındaki günler `13 Eylül 2026` biçiminde gösterilir ve IP sayfa dökümü seçilen tarihle sınırlandırılır. Üstteki iki kart eşit yükseklikte birlikte uzar; açık içerik kesilmez. Önceki/sonraki düğmeleri eşit ölçüdedir ve son sayfadaki kayıt sayısı azalsa da sayfalama konumu değişmez. İç kaydırma kullanılmaz.
